            ...
            if level == 1:
                    ...
                    for server in plex_account.resources():
                        ...
                        if "server" in r_type:
                            valid = (
                                ...
                                in [
                                    s.get("plexToken")
                                    for s in servers_file().get("items")
                                ]
                                else False
                            )
                            items.append(
                                {
                                    ...
                                    "icon": {
                                        "path": (
                                            "icons/base/server.webp"
                                            if valid
                                            else "icons/base/server_hide.webp"
                                        )
                                    },
                                }
                            )
                ...
                if _type == "people":
                    ...
                    for device in plex_account.devices():
                        devices_icons_folder = [
                            file
                            for file in os.listdir(
                                os.path.join(os.getcwd(), "icons/devices")
                            )
                            if not file.startswith(".") and file != "plex.webp"
                        ]
                        ...
                        for filename in devices_icons_folder:
                            current_index = check_icons_string.find(
